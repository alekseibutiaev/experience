...
namespace {
  ...
  void handle_resolve(resolver_ptr rsl, net::socket_events_t func, const net::error_code_t& err,
      endpoints_t endpoints) {
    if(!err) {
      net::details::socket_t* socket = new net::details::socket_t(get_ctx(rsl));
